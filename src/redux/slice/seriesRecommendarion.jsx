...
const seriesRecommendationsSlice = createSlice({
  name: "details",
  initialState: data,
  extraReducers: (builder) => {
    builder.addCase(getSeriesRecommendations.pending, (state) => {
      state.loading = true;
    });
    ...
    builder.addCase(getSeriesRecommendations.rejected, (state) => {
      state.loading = false;
    });
  },
});

export const seriesRecommendations = seriesRecommendationsSlice.reducer;
